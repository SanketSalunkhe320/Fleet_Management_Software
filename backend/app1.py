# #!/usr/bin/env python3
# """
# Flask API that reads AMCL pose data from ROS bag in real-time
# Run this FIRST, THEN play your ROS bag
# """
...
#         print("💡 Now play your ROS bag: ros2 bag play my_amcl_bag_0.db3")
#         print("📊 Waiting for AMCL pose data...")
...
# def home():
#     return jsonify({
#         'message': 'ROS Bag AMCL Position API',
#         'status': 'Ready to receive bag data',
#         'instructions': 'Play your ROS bag: ros2 bag play my_amcl_bag_0.db3',
#         'endpoints': {
#             '/robot_position': 'GET - Get current robot position from bag',
...
#     """Get the current robot position from bag data"""
#     global latest_robot_position
...
#         'timestamp': time.time(),
#         'message': f'Received {latest_robot_position["message_count"]} messages so far'
#     })
...
#         'last_update': time.time() - latest_robot_position['timestamp'] if latest_robot_position['timestamp'] > 0 else 'Never'
#     })
...
#     return jsonify({
#         'status': 'healthy',
#         'service': 'ROS Bag AMCL Position API',
#         'timestamp': time.time()
#     })
...
#         'instructions': 'Make sure ROS bag is playing with: ros2 bag play my_amcl_bag_0.db3'
#     })
...
#     print("\n" + "="*60)
#     print("🎒 ROS BAG AMCL POSITION READER")
#     print("="*60)
...
#     print("   3. Play your ROS bag: ros2 bag play my_amcl_bag_0.db3")
#     print("   4. Watch for position updates above!")
#     print("   5. Open your React frontend to see the robot move")
#     print("="*60 + "\n")
